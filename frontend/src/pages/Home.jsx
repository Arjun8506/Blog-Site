...
const Home = () => {
  return (
    <div className='py-8 w-full min-h-screen'>
      ...
      <div className='px-20'>
      <h1 className='text-6xl uppercase font-bold text-purple-800 first-letter:text-purple-950 first-letter:text-8xl'>Welcome to my blog site</h1>

      <h2 className='text-1xl px-5 capitalize font-semibold text-zinc-800 first-letter:text-black first-letter:text-2xl my-2'>where you can read blogs related to    
